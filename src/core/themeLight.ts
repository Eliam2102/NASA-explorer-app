...
export const nasaLightTheme = {
    ...
    surface: "#F5F5F5",       // Fondo de tarjetas u otras superficies
    onSurface: "#0B3D91",     // Texto principal en superficies claras
  
    textPrimary: "#0B3D91",   // Texto destacado
    textSecondary: "#4A4A4A", // Texto secundario
